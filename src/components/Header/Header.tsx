...
export default function Header({ onCartIconClick }: Props) {
  ...
  return (
    <header className=" z-10 bg-white text-gray-700 py-4 flex items-center justify-between h-48 sticky top-0 shadow">
      <div className="z-10 flex-col bg-white text-gray-700 py-4 flex items-center justify-between h-48 sticky top-0 shadow">
